package BackEnd1.ClinicaOdontologica.dao;

import BackEnd1.ClinicaOdontologica.model.Domicilio;
...
public class PacienteDAOH2 implements iDao<Paciente> {
    ...
    public void eliminar(Integer id) {
        logger.info("Iniciando la operación de eliminación de un paciente con ID: " + id);
        Connection connection = null;
        try {
            connection = BD.getConnection();
